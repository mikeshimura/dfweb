...
//func CreateParameter(svalue string, goType string) reflect.Value {
//	switch goType {
//	case "string":
//		return reflect.ValueOf(svalue)
//	case "sql.NullString":
//		return reflect.ValueOf(df.CreateNullString(svalue))
//	case "int64":
//		cv, err := strconv.Atoi(svalue)
//		if err != nil {
//			panic("int64 変換エラー :" + svalue)
//		}
//		return reflect.ValueOf(int64(cv))
//	case "sql.NullInt&4":
//		cv, err := strconv.Atoi(svalue)
//		if err != nil {
//			panic("int64 変換エラー :" + svalue)
//		}
//		return reflect.ValueOf(df.CreateNullInt64(int64(cv)))
//	case "float64":
//		cv, err := strconv.ParseFloat(svalue, 64)
//		if err != nil {
//			panic("float64 変換エラー :" + svalue)
//		}
...
//			panic("float64 変換エラー :" + svalue)
//		}
//		return reflect.ValueOf(df.CreateNullFloat64(cv))
//	case "Time.time":
//		cv, err := time.Parse(df.DISP_SQL_DEFAULT_TIME_FORMAT, svalue)
//		if err != nil {
//			panic("Time 変換エラー :" + svalue)
//		}
//		return reflect.ValueOf(cv)
//	case "pq.NullTime":
//		cv, err := time.Parse(df.DISP_SQL_DEFAULT_TIME_FORMAT, svalue)
...
//			panic("Time 変換エラー :" + svalue)
//		}
//		return reflect.ValueOf(df.CreateNullTime(cv))
//	case "df.Date":
//		cv, err := time.Parse(df.DISP_SQL_DEFAULT_DATE_FORMAT, svalue)
//		if err != nil {
//			panic("Date 変換エラー :" + svalue)
//		}
//		return reflect.ValueOf(df.CreateDate(cv))
//	case "df.NullDate":
//		cv, err := time.Parse(df.DISP_SQL_DEFAULT_DATE_FORMAT, svalue)
//		if err != nil {
//			panic("Date 変換エラー :" + svalue)
//		}
//		return reflect.ValueOf(df.CreateNullDate(cv))
//	case "df.Timestamp":
//		cv, err := time.Parse(df.DISP_SQL_DEFAULT_TIMESTAMP_FORMAT, svalue)
//		if err != nil {
//			panic("Timestamp 変換エラー :" + svalue)
//		}
//		return reflect.ValueOf(df.CreateTimestamp(cv))
//	case "df.NullTimestamp":
//		cv, err := time.Parse(df.DISP_SQL_DEFAULT_TIMESTAMP_FORMAT, svalue)
//		if err != nil {
//			panic("Timestamp 変換エラー :" + svalue)
//		}
//		return reflect.ValueOf(df.CreateNullTimestamp(cv))
//	}
